...
public class DefineOptionalSubject {
  WebDriver dr;
  String pg="DefineOptionalSubject";
  Utility u= new Utility();

  @FindBy(id="ContentPlaceHolder1_txtOptSubName_TextBox")WebElement subjectname;
  ...
  public DefineOptionalSubject(WebDriver d)
  {
     this.dr=d;
	 PageFactory.initElements(d, this); 
  }	  
  public void openDefineOptionalSubject()
  {
     WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	 Actions builder= new Actions(dr);
	 builder.moveToElement(menu).build().perform();
	 dr.findElement(By.linkText("Define Optional Subject")).click();
	 dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/SchoolCommonDetails/Optional_Subject.aspx']")));
  }
  ...
  public void clickView(String school, Collection<String> sc)throws IOException
  {
      ...
      if (cells.size()>1) {
          for (WebElement cell : cells) {
              cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptoptionalsubject')]")).click();
              break;
          }
