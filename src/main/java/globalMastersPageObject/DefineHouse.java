...
public class DefineHouse {
  WebDriver dr;
  String pg="DefineHouse";
  Utility u= new Utility();

  @FindBy(id="ContentPlaceHolder1_txtHouse_TextBox")WebElement house;
  ...
  public DefineHouse(WebDriver d)
  {
     this.dr=d;
	 PageFactory.initElements(d, this); 
  }	  
  public void openDefineHouse()
  {
     WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	 Actions builder= new Actions(dr);
	 builder.moveToElement(menu).build().perform();
	 dr.findElement(By.linkText("Define House")).click();
	 dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/SchoolCommonDetails/DefineHouse.aspx']")));
  }
  ...
  public void enterHouse(String hs)
  {
      house.sendKeys(hs);
  }
  ...
  public void clickView(String school, Collection<String> sc)throws IOException
  {
      ...
      if (cells.size()>1) {
          for (WebElement cell : cells) {
              cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptHouse')]")).click();
              break;
          }
